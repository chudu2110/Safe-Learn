...
export const ICONS = {
  ...
  trash: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="w-6 h-6"><path d="M3 6h18" strokeWidth="2" strokeLinecap="round"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" strokeWidth="2" strokeLinecap="round"/><rect x="5" y="6" width="14" height="16" rx="2" strokeWidth="2"/><path d="M10 11v7M14 11v7" strokeWidth="2" strokeLinecap="round"/></svg>,
  ...
  chartBar: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="w-5 h-5"><path d="M3 21h18" strokeWidth="2" strokeLinecap="round"/><rect x="6" y="11" width="3" height="7" rx="1" strokeWidth="2"/><rect x="11" y="7" width="3" height="11" rx="1" strokeWidth="2"/><rect x="16" y="13" width="3" height="5" rx="1" strokeWidth="2"/></svg>,
  userGroup: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="w-5 h-5"><circle cx="12" cy="8" r="3" strokeWidth="2"/><path d="M6 20v-1a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v1" strokeWidth="2" strokeLinecap="round"/><circle cx="19" cy="9" r="2" strokeWidth="2"/><path d="M18 14a3 3 0 0 1 3 3v3" strokeWidth="2" strokeLinecap="round"/></svg>,
  checkCircle: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="w-5 h-5"><circle cx="12" cy="12" r="9" strokeWidth="2"/><path d="M9 12l2 2 4-4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  activity: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="w-5 h-5"><path d="M3 12h4l3-8 4 16 3-8h4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  user: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="w-5 h-5"><circle cx="12" cy="8" r="3" strokeWidth="2"/><path d="M6 20v-1a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v1" strokeWidth="2" strokeLinecap="round"/></svg>,
};
...
export const ROADMAP_HS_DATA: RoadmapItem[] = [
    { id: 1, type: 'lesson', title: 'Bài 1: Con trai con gái và sự công bằng', status: 'completed', position: { top: '5%', left: '60%' } },
    { id: 2, type: 'lesson', title: 'Bài 2: Động chạm không an toàn', status: 'completed', position: { top: '18%', left: '35%' } },
    { id: 3, type: 'lesson', title: 'Bài 3: Con trai và bao quy đầu', status: 'current', position: { top: '30%', left: '70%' } },
    { id: 4, type: 'lesson', title: 'Bài 4: Trẻ vị thành niên mang thai', status: 'locked', position: { top: '45%', left: '50%' } },
    { id: 5, type: 'lesson', title: 'Bài 5: Xâm hại trên mạng xã hội', status: 'locked', position: { top: '60%', left: '30%' } },
    { id: 6, type: 'lesson', title: 'Bài 6: Thay đồ nơi công cộng', status: 'locked', position: { top: '75%', left: '65%' } },
    { id: 7, type: 'lesson', title: 'Bài 7: Xâm hại ở trường học', status: 'locked', position: { top: '88%', left: '40%' } },
    { id: 8, type: 'badge', title: 'Huy Hiệu "Phòng Tránh Xâm Hại"', status: 'locked', position: { top: '100%', left: '55%' } },
];
